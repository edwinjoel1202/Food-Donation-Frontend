      ...
      <Row>
        {filtered.map((d) => (
          <Col md={4} key={d.id} className="mb-3">
            <Card>
              {d.imageUrl && (
                <Card.Img variant="top" src={d.imageUrl} alt={d.title} />
              )}
              <Card.Body>
                ...
                {d.pickupAddress && (
                  <div style={{ marginBottom: 8 }}>
                    <small className="text-muted-small">Pickup: </small>{" "}
                    {d.pickupAddress}
                  </div>
                )}
                ...
                {d.pickupLat && d.pickupLng && (
                  <div style={{ height: 160, marginBottom: 8 }}>
                    <MapContainer
                      center={[d.pickupLat, d.pickupLng]}
                      zoom={13}
                ...
                <Button as={Link} to={`/donations/${d.id}`} variant="primary">
                  Details
                </Button>
              </Card.Body>
            </Card>
